							 ...
							 <?php
                                ...
                                <p style="font-size: 20px;">
                                    <span class="label label-success">
                                        <i class="fas fa-medal"></i> Bestseller <script>document.write(new Date().getFullYear())</script>
                                    </span>
                                </p>
...
<center><a href='./'>Home</a> | <a href='./contact.php' target='_blank'>Contact</a> | <a href='./dmca.php' target='_blank'>DMCA</a> | <a href='./disclaimer.php' target='_blank'>Disclaimer</a></center></p>
                      </div>
                    </div>
...
<div id="footer">
  ...
  <p>Design copyright &copy; 2015 <a href="./" title="SimplyGold"><?php echo $webname; ?>x</a></p></div>
</div>
</body>
</html>
