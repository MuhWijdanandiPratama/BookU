...
<HTML><HEAD><TITLE>Disclaimer Information - <?php echo $webname;?></TITLE>
<META content="text/html; charset=utf-8" http-equiv=Content-Type>
<STYLE type=text/css>
BODY {
	TEXT-ALIGN: center; FONT: 11px Verdana; CURSOR: default
}
SPAN {
	COLOR: #ccc
}
...
DIV {
	TEXT-ALIGN: justify; LINE-HEIGHT: 160%; MARGIN: 0px auto; WIDTH: 800px
}
.STYLE1 {color: #FF0000}
</STYLE>
...
<h2>Good Faith Recommendations</h2>
...
<h2>Potential Bias and Due Diligence</h2>
...
<h2>Questions Regarding Any Purchases</h2>
<p>The owner’s aim is to provide the best products and services available to you. If you have any questions regarding any such purchases, then please contact us immediately and we will do what we can to answer them or rectify any issues you may have.</p>
<br>
<br>
<br>
<br>
